...
<!--      <h2  @click="choose(blogs[item-1].tmId)"></h2>-->
      <h1 align="center"><router-link style="font-size: 28px" tag="el-link" class="ptitle" :to="{ name:'teacher_Message_detail',params:{tmid:blogs[item-1].tmId} }" >{{blogs[item-1].tmType}}：“{{blogs[item-1].tmTitle}}”······························{{blogs[item-1].tmPtime}}</router-link></h1>
    </el-carousel-item>
  </el-carousel>
</template>
